...
public class receive_data_accel : MonoBehaviour
{
    ...
    public float yaw_velocity;  //角速度
    public float yaw_accel;     //角加速度
    //
    ...
    void OnDataReceived(string message)
    {
        try
        {
            ...
            P1 = int.Parse(data[3]);
            yaw_velocity = float.Parse(data[4]);
            yaw_accel = float.Parse(data[5]);
        }
