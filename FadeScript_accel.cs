...
public class FadeScript_accel : MonoBehaviour
{
    ...
    {
        //
        fadein_flag = VReyeController.GetComponent<VReyeController_accel>().fade_in;
        fadeout_flag = VReyeController.GetComponent<VReyeController_accel>().fade_out;
        //フェード機能のオンオフ
