...
public class VReyeController_UDP : MonoBehaviour
{
    //Publicオブジェクト（格納）
    ...
    {
        //シリアル通信から値を取得
        yaw_angle = UDP_Data_Receiver.GetComponent<UDP>().yaw_val;
        pitch_angle = UDP_Data_Receiver.GetComponent<UDP>().pitch_val;
