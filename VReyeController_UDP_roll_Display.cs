...
public class VReyeController_UDP_roll_Display : MonoBehaviour
{
    //Publicオブジェクト（格納）
    ...
    {
        //シリアル通信から値を取得
        yaw_angle = UDP_Data_Receiver.GetComponent<UDP_roll_Display>().yaw_val;
        pitch_angle = UDP_Data_Receiver.GetComponent<UDP_roll_Display>().pitch_val;
        roll_angle = UDP_Data_Receiver.GetComponent<UDP_roll_Display>().roll_val;
